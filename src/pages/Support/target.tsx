export const Target = () => {
  ...
  return (
    <div
      className="text-[12px] ssm:none px-[12px] py-[16px] rounded-lg bg-white shadow-md transition-all duration-300 hover:shadow-lg flex flex-col gap-[8px] text-left ssm:hidden"
      style={{
        position: 'fixed',
        left: '1%',
        top: '50%',
    ...
    >
      <div
        className="text-[14px] text-blue-600 mt-[12px] mb-[6px] hover:scale-[105%] transition-transform duration-300 cursor-pointer font-bold"
